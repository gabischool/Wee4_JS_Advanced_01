...
let fullName = [];
 ...
 runners.forEach((runner) => {
    return fullName.push(runner.first_name,runner)
 })
...
allCaps = runners.map((uppercase) =>  {
    uppercase.first_name.toLocaleLowerCase()
})
...
const largeShirts =  runners.filter((runn) => runn.shirt_size === 'XL')
