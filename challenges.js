...
const namee = prompt("what is the student's name?")
let ispresent = true;
ispresent = prompt("is the student in the class?")
markAttendance(namee, ispresent)
// Extra Task:
// - Convert the function into a function expression.
const markAttendance = function (stdntName, isPresent) {
   if(isPresent == true){
       console.log(stdntName + "is present ")
   }else{
      console.log(stdntName + "is absent "  ) 
...
const namee2 = prompt("what is the student's name?")
let ispresent2 = true;
ispresent = prompt("is the student in the class?")
markAttendance(namee2, ispresent2)
...
const calculateAverage = (test1, test2, test3)=> {
   let average = (parseFloat(test1 + test2 + test3)/3).toFixed(2);
   return average;
...
function generateReport(stName, test1a, test2a, test3a) {
   ...
   console.log("Name: " + stName +" Average Scores:  " + result + " " + gradeLetter )
}
